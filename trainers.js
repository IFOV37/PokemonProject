...
module.exports = function(){
    ...
    function getTrainers(res, mysql, context, complete){
    	mysql.pool.query("SELECT Trainers.id, Trainers.name, catchphrase, p.name FROM Trainers INNER JOIN Pokemon p ON p.trainerID = Trainers.id", function(error, results, fields){
    		if(error){
